...
public class ts019_TestClientExternaluser extends init_class {
	
	@Test(priority=18)
	public static void externalUser()
	{
		...
		}catch(Throwable t)
		{
			...
			a.moveToElement(externaluser).click().build().perform();//*[@id="left-panel"]/nav/ul/li[2]/ul/li[2]/a
		}
		WebElement externaluser = driver.findElement(By.xpath("//*[@id='left-panel']/nav/ul/li[2]/ul/li[2]/a"));
		Actions a =new Actions(driver);
		a.moveToElement(externaluser).click().build().perform();
