...
public class ts027_TestClientVisitorsCustomers extends init_class{
	@Test(priority=26)
	public static void visitorsCustomers()
	{
		...
		driver.findElement(By.xpath("//*[@id='left-panel']/nav/ul/li[9]/ul/li[1]/a")).click();
	}
