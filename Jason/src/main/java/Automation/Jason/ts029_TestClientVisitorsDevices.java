...
public class ts029_TestClientVisitorsDevices extends init_class {
	
	@Test(priority=28)
	public static void visitorsDevices()
	{
		...
		driver.findElement(By.xpath("//*[@id='left-panel']/nav/ul/li[9]/ul/li[3]/a")).click();
	}
