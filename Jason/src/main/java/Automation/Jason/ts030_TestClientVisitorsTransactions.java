...
public class ts030_TestClientVisitorsTransactions extends init_class {
	
	@Test(priority=29)
	public static void visitorsTransactions()
	{
		...
		driver.findElement(By.xpath("//*[@id='left-panel']/nav/ul/li[9]/ul/li[4]/a")).click();
	}
